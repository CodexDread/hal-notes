...
const api: HalApi = {
  ...
  halHistory: () => ipcRenderer.invoke('hal:history'),
  halHistoryClear: () => ipcRenderer.invoke('hal:history-clear'),
  ...
  pluginSetEnabled: (id, enabled) => ipcRenderer.invoke('plugins:set-enabled', id, enabled),
  pluginInstallFromFolder: (path) => ipcRenderer.invoke('plugins:install-from-folder', path),
  pluginRemove: (id) => ipcRenderer.invoke('plugins:remove', id),
  pluginReadCode: (id) => ipcRenderer.invoke('plugins:read-code', id),
  ...
  pluginStorageKeys: (pluginId) => ipcRenderer.invoke('plugin-storage:keys', pluginId),
  aiChat: (reqId, req) => ipcRenderer.invoke('ai:chat', reqId, req),
  filesSaveText: (defaultName, content) => ipcRenderer.invoke('files:save-text', defaultName, content),
