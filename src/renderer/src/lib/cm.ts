...
export function livePreview(): Extension {
  return [
    ...
    EditorView.theme({
      '.cm-preview-h1': { fontSize: '1.6em', fontWeight: '700', color: 'var(--hal-amber)', lineHeight: '1.4', letterSpacing: '-0.01em', paddingTop: '0.9em', paddingBottom: '0.35em' },
      '.cm-preview-h2': { fontSize: '1.4em', fontWeight: '600', color: 'var(--hal-amber)', lineHeight: '1.4', letterSpacing: '-0.01em', opacity: '0.9', paddingTop: '0.7em', paddingBottom: '0.25em' },
      '.cm-preview-h3': { fontSize: '1.2em', fontWeight: '600', color: 'var(--hal-ivory)', lineHeight: '1.4', paddingTop: '0.55em', paddingBottom: '0.2em' },
      '.cm-preview-h4': { fontSize: '1.05em', fontWeight: '600', color: 'var(--hal-ivory)', lineHeight: '1.4', paddingTop: '0.45em', paddingBottom: '0.15em' },
