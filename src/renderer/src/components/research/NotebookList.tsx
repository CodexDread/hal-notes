  ...
  return (
    <aside className="flex h-full w-60 shrink-0 flex-col border-r border-zinc-800 bg-zinc-900/40">
      <div className="flex items-center justify-between px-3 py-2">
        <span className="text-[11px] font-semibold uppercase tracking-wider text-zinc-500">Notebooks</span>
        <button
          title="New notebook"
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-2 pb-4">
        {notebooks.length === 0 && !creating && (
          <p className="px-2 py-3 text-xs leading-5 text-zinc-600">
        ...
        {creating && (
          <input
            autoFocus
            className="mb-1 w-full rounded-md border border-zinc-700 bg-zinc-900 px-2 py-1.5 text-sm outline-none focus:border-violet-500"
